...
| `"meta"`              | map     | Map containing information on how the generator should process certain data                                    | See below                                  |
| `"common_components"` | map     | Indicates components that should be shared across all items (ie. lore, tooltip)                                | See below                                  |
...
| `"recipe"`      | map               | A variation of the item's crafting recipe                                                                               | See below                                                              |
